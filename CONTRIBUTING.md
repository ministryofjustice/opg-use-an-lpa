...
For PHP code we use [Psalm](https://psalm.dev/), [PHPCS](https://github.com/PHPCSStandards/PHP_CodeSniffer/wiki) and code to [PSR-12](https://www.php-fig.org/psr/psr-12/).
