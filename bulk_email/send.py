...
def main():
    ...
    with open(args.file) as f:
        for line_terminated in f:
            ...
            print(email_address)
            send_msg(email_address)
        #with open(filename + '_succeeded', 'w') as succeededfile:
        #    with open(filename + '_failed', 'w') as failedfile:
    # TODO with open success file and failed file    
