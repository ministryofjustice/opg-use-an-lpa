...
def step_impl(context):
  context.browser.get(get_frontend_url('viewer'))
...
def step_impl(context, help_link):
  help_summary = context.browser.find_element_by_xpath('//summary/span[contains(text(),"' + help_link + '")]')
  help_summary.click()
...
def step_impl(context, error_message, input_label):
  error_message_element = context.browser.find_element_by_xpath('//label[contains(text(), "' + input_label + '")]/../span[contains(concat(" ", @class, " "), " govuk-error-message ")]')
...
def step_impl(context, lpa_type, donor_name):
  lpa_type_element = context.browser.find_element_by_xpath('//table[@id="confirmation-table"]//td[contains(text(),"' + lpa_type + '")]')
  assert lpa_type_element.text == lpa_type
  donor_name_element = context.browser.find_element_by_xpath('//table[@id="confirmation-table"]//td[contains(text(),"' + donor_name + '")]')
...
def step_impl(context, help_link, visibility):
  help_link_element = context.browser.find_element_by_xpath('//span[contains(concat(" ", @class, " "), " govuk-details__summary-text ")][contains(text(), "' + help_link + '")]')
  help_text = context.browser.find_element_by_css_selector('.govuk-details__text')
