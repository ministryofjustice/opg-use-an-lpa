...
```shell
aws-vault exec identity -- uv run python ./dynamodb_export.py --environment demo
```
...
```shell
aws-vault exec identity -- uv run python ./dynamodb_export.py --environment demo --check_exports
