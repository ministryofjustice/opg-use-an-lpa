...
class AccountLookup:
    ...
    def get_viewer_code(self, viewer_code):
        response = self.aws_dynamodb_client.query(
            TableName=f"{self.environment}-ViewerCodes",
    ...
    def print_plaintext(self):
        print(
            f"Viewer Code: {self.output_json['viewer_code']['code']}",
            f"\n\tEmail: {self.output_json['email']}",
            f"\n\tLPA Id: {self.output_json['viewer_code']['lpa_id']}",
            f"\n\tAdded: {self.output_json['viewer_code']['added']}",
            f"\n\tExpires: {self.output_json['viewer_code']['expires']}",
            "\n"
        )
