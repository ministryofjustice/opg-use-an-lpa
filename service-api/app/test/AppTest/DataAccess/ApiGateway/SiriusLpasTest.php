...
class SiriusLpasTest extends TestCase
{
    ...
    public function requests_a_letter_successfully_for_modernised_lpa(): void
    {
        ...
        $this->eventBridgeClient
            ...
            ->willReturn(new Result(['FailedEntryCount' => 0]))
            ->shouldBeCalled();
    ...
    #[Test]
    public function requests_a_cleanse_successfully_for_modernised_lpa(): void
    {
        $this->generateCleanPSR17Prophecies();

        $entry = [
            'Source'       => 'opg.poas.use',
            'DetailType'   => 'request-cleanse',
            'Detail'       => json_encode([
                'uid'   => 'M-7890-0400-4000',
                'notes' => 'Some details about this I guess',
            ]),
            'EventBusName' => 'my test bus',
            'TraceHeader'  => 'test-trace-id',
        ];
        ...
        $service->requestLetter(new LpaUid('M-7890-0400-4000'), null, 'Some details about this I guess');
    }

    #[Test]
    public function requests_a_letter_for_modernised_errors(): void
    {
        $this->generateCleanPSR17Prophecies();
        ...
        $this->loggerInterface
            ->warning('Failed to put event for LPA {lpaUid}', Argument::any())
            ->shouldBeCalled();
