...
class LpaAlreadyAddedTest extends TestCase
{
    ...
    public function returns_null_if_lpa_not_already_added(): void
    {
        ...
        $lpaAddedData = ($this->getLpaAlreadyAddedService())($this->userId, new LpaUid('700000000321'));
    ...
    public function returns_not_activated_flag_if_lpa_requested_but_not_active(): void
    {
        ...
        $lpaAddedData = ($this->getLpaAlreadyAddedService())($this->userId, new LpaUid($this->lpaUid));
        $this->assertEquals(
            [
                'donor'         => [
                    'uId'        => '700000000444',
    ...
    public function returns_null_if_different_lpa_added(): void
    {
        ...
        $lpaAddedData = ($this->getLpaAlreadyAddedService())($this->userId, new LpaUid('712312341234'));
        $this->assertNull($lpaAddedData);
    }
