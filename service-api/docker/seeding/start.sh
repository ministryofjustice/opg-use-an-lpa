...
if [[ -n "${AWS_ENDPOINT_DYNAMODB}" ]]; then
    ...
    --attribute-definitions AttributeName=Id,AttributeType=S AttributeName=Identity,AttributeType=S AttributeName=Email,AttributeType=S AttributeName=ActivationToken,AttributeType=S \
