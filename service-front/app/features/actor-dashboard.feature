...
Feature: The user is able to see correct information on their dashboard
  ...
  Scenario Outline: Old lPA type label is correctly displayed on dashboard
    Given I am on the dashboard page to check LPA of subtype "<subtype>" and uid "<uid>"
  ...
  Scenario Outline: As a user I can see the number of active access codes an LPA has
    ...
    Examples:
      ...
      | 2 active access codes               |  +3weeks    | +3weeks     |
      | 1 active access code                |  -1week     | +3weeks     |
      | No active access codes              |  -1day      | -1week      |
