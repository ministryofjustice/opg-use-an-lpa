...
Feature: View an LPA via sharecode
  ...
  Scenario Outline: The user is shown the correct error messages when entering invalid details
    ...
    Examples:
      | accessCode             | reason                                      |
      | V-T3ST ACE2 C0D35      | Enter LPA access code in the correct format |
      | V-T3STACE2C0D35        | Enter LPA access code in the correct format |
      | T3STACE2C0D35          | Enter LPA access code in the correct format |
      ...
      |                        | Enter LPA access code in the correct format |
