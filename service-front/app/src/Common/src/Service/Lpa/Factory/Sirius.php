...
final class Sirius implements LpaFactory
{
    ...
    public function createLpaFromData(array $data): Lpa
    {
        ...
        if (isset($data['hasSeveranceWarning'])) {
            $lpa->setHasSeveranceWarning($data['hasSeveranceWarning']);
        }
    ...
    public function createCaseActorFromData(array $caseActorData): CaseActor
    {
        ...
        if (isset($caseActorData['firstnames'])) {
            $actor->setFirstname($caseActorData['firstnames']);
        }
        if (isset($caseActorData['otherNames'])) {
            $actor->setOtherNames($caseActorData['otherNames']);
        }
