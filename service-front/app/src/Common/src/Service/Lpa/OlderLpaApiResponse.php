...
class OlderLpaApiResponse
{
    ...
    /** @var string An activation key has already been requested for this LPA */
    public const LPA_ALREADY_REQUESTED  = 'LPA_ALREADY_REQUESTED';
