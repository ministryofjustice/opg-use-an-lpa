...
class OneLoginService implements LogoutStrategy
{
     ...
     * @param AuthenticationData $authCredentials Our generated session values and options
     * @return UserInterface
     * @throws ApiException
     */
    public function callback(string $code, string $state, AuthenticationData $authCredentials): UserInterface
    {
