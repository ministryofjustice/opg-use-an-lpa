    ...
    WorkflowStep
{
    ...
    {
        if ($state->sentToDonor) {
            return $state->noOfAttorneys !== null && $state->dateOfBirth !== null && $state->attorneyName !== null;
        }

        return $state->noOfAttorneys !== null &&  $state->dateOfBirth !== null;
    }
}
