...
namespace Viewer\Service\Lpa\Factory;
...
final class Sirius implements LpaFactory
{
    ...
    public function createLpaFromData(array $data) : Lpa
    {
        ...
        $lpa = new Lpa();
        if (isset($data['id'])) { $lpa->setId($data['id']); }
        if (isset($data['uId'])) { $lpa->setUId($data['uId']); }
        if (isset($data['applicationType'])) { $lpa->setApplicationType($data['applicationType']); }
        if (isset($data['caseSubtype'])) { $lpa->setCaseSubtype($data['caseSubtype']); }
        if (isset($data['receiptDate'])) { $lpa->setReceiptDate(new DateTime($data['receiptDate'])); }
        if (isset($data['rejectedDate'])) { $lpa->setRejectedDate(new DateTime($data['rejectedDate'])); }
        if (isset($data['registrationDate'])) { $lpa->setRegistrationDate(new DateTime($data['registrationDate'])); }
        if (isset($data['status'])) { $lpa->setStatus($data['status']); }
        if (isset($data['caseAttorneySingular'])) { $lpa->setCaseAttorneySingular($data['caseAttorneySingular']); }
        if (isset($data['caseAttorneyJointlyAndSeverally'])) { $lpa->setCaseAttorneyJointlyAndSeverally($data['caseAttorneyJointlyAndSeverally']); }
        if (isset($data['caseAttorneyJointly'])) { $lpa->setCaseAttorneyJointly($data['caseAttorneyJointly']); }
        if (isset($data['caseAttorneyJointlyAndJointlyAndSeverally'])) { $lpa->setCaseAttorneyJointlyAndJointlyAndSeverally($data['caseAttorneyJointlyAndJointlyAndSeverally']); }
        if (isset($data['applicationHasRestrictions'])) { $lpa->setApplicationHasRestrictions($data['applicationHasRestrictions']); }
        ...
        if (isset($data['donor'])) { $lpa->setDonor($this->createCaseActorFromData($data['donor'])); }
        if (isset($data['attorneys'])) { $lpa->setAttorneys($this->createCaseActorsFromData($data['attorneys'])); }
        if (isset($data['replacementAttorneys'])) { $lpa->setReplacementAttorneys($this->createCaseActorsFromData($data['replacementAttorneys'])); }
        if (isset($data['trustCorportations'])) { $lpa->setTrustCorporations($this->createCaseActorsFromData($data['trustCorportations'])); }
        if (isset($data['certificateProviders'])) { $lpa->setCertificateProviders($this->createCaseActorsFromData($data['certificateProviders'])); }
    ...
    private function createCaseActorFromData(array $caseActorData) : CaseActor
    {
        ...
        if (isset($caseActorData['dob'])) { $actor->setDob(new DateTime($caseActorData['dob'])); }
        if (isset($caseActorData['salutation'])) { $actor->setSalutation($caseActorData['salutation']); }
        if (isset($caseActorData['firstname'])) { $actor->setFirstname($caseActorData['firstname']); }
    ...
    private function createAddressFromData(array $addressData) : Address
    {
        ...
        if (isset($addressData['type'])) { $address->setType($addressData['type']); }
        if (isset($addressData['addressLine1'])) { $address->setAddressLine1($addressData['addressLine1']); }
        if (isset($addressData['addressLine2'])) { $address->setAddressLine2($addressData['addressLine2']); }
        if (isset($addressData['addressLine3'])) { $address->setAddressLine3($addressData['addressLine3']); }
