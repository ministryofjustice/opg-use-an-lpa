...
class RequestReferenceNumberTest extends TestCase implements TestsLaminasForm
{
    ...
    public function it_sets_correct_validator_when_flag_set_to_true()
    {
        ...
        $key = array_search('Common\Validator\ChecksumValidator', array_column($validators, 'name'));

        $this->assertContains($validators[$key]['name'], 'Common\Validator\ChecksumValidator');
    }
