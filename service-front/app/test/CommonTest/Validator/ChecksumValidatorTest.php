...
class ChecksumValidatorTest extends TestCase
{
    ...
    public function testIsValidNotValidFormat($reference_number)
    {
        ...
        $this->assertEquals([
            ChecksumValidator::NOT_VALID => 'Entered LPA reference number is not correct',
    ...
    public function testLpaReferenceStartsWithSeven($reference_number)
    {
        ...
        $this->assertEquals([
                ChecksumValidator::LPA_MUST_START_WITH =>
    ...
    public function testMerisReferenceStartsWithSeven($reference_number)
    {
        ...
        $this->assertEquals([
                ChecksumValidator::MERIS_NO_MUST_START_WITH =>
    ...
    public function testIsValidInvalid($reference_number)
    {
        ...
        $this->assertEquals([
                ChecksumValidator::MUST_BE_LENGTH =>
