/**
 * The upstream of this file (https://github.com/govuk-one-login/service-header/blob/main/dist/scripts/service-header.js)
 * does not export anything for module based includes. This is a straight copy of that file with an export tacked on.
 */
