...
resource "aws_security_group_rule" "actor_ecs_service_egress_vpc_endpoints" {
...
resource "aws_security_group_rule" "actor_ecs_service_egress_s3_endpoint" {
...
resource "aws_security_group_rule" "actor_ecs_service_egress_api_service" {
