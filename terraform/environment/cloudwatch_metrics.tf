locals {
  event_codes = [
    ...
    "FULL_MATCH_KEY_REQUEST_SUCCESS_LPA_TYPE_HW",
    "FULL_MATCH_KEY_REQUEST_SUCCESS_LPA_TYPE_PF",
    "PARTIAL_MATCH_KEY_REQUEST_SUCCESS_LPA_TYPE_HW",
    "PARTIAL_MATCH_KEY_REQUEST_SUCCESS_LPA_TYPE_PF",
  ]
}
