...
locals {
  cluster_config = {
    ...
    viewer_load_balancer_security_group_id = aws_security_group.viewer_loadbalancer.name
    actor_load_balancer_security_group_id  = aws_security_group.actor_loadbalancer.name
  }
}
