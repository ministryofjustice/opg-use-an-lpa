locals {
  event_codes = [
    ...
    "event_code.AUTH_ONELOGIN_ACCOUNT_CONTAINS_IDENTITY",
    "event_code.AUTH_ONELOGIN_ACCOUNT_CREATED_WITH_ORPHAN_BYPASS",
    "event_code.INSTRUCTIONS_PREFERENCES_IMAGES_NEW_EXTRACT",
    "event_code.INSTRUCTIONS_PREFERENCES_IMAGES_ERROR",
  ]
}
